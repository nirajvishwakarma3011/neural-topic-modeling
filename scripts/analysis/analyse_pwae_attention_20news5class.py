...
# ── Config ─────────────────────────────────────────────────────────────────────
MODEL_PATH  = "models/pwae_ntm_20news_5class_seed42_8eca7b4ec8/model"
...
raw_labels = df[LABEL_COLS].values

# apply same filtering as the loader (drop empty-after-clean docs)
MIN_DOC_LEN = 5
